 ...
 */
final class Version20240101163246 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE membre (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, nom_membre VARCHAR(255) NOT NULL, prnm_membre VARCHAR(255) NOT NULL, cpmembre VARCHAR(6) DEFAULT NULL, adr_membre VARCHAR(50) DEFAULT NULL, ville_membre VARCHAR(50) DEFAULT NULL, tel_membre VARCHAR(10) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE recette (id INT AUTO_INCREMENT NOT NULL, membre_id INT DEFAULT NULL, nom_recette VARCHAR(255) NOT NULL, temps_recette TIME DEFAULT NULL, diff_recette INT NOT NULL, instruction LONGTEXT DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, note_moyenne DOUBLE PRECISION NOT NULL, INDEX IDX_49BB63906A99F74A (membre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
